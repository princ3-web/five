      ...
      <div className={app.section}>
        <div className={background.imageScroller}>
          ...
          <img
            ...
            src={require("../assets/images/background2.we")}
            alt=""
          />
          ...
          <img
            ...
            onClick={() =>
              selectedBackground < 2 ? toggleSelectedBackground((state) => state + 1) : toggleSelectedBackground(0)
            }
          ...
          <img
            className={background.arrow}
            onClick={() =>
              selectedBackground > 0 ? toggleSelectedBackground((state) => state - 1) : toggleSelectedBackground(2)
            }
