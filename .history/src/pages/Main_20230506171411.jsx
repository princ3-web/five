...
const Main = () => {
  ...
  const backgroundsText = [
    {title: "Processo" text: "Introducing the revolutionary new processors, delivering lightning-fast speeds and unparalleled performance to power your business into the future."},
