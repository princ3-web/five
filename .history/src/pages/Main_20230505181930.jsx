...
const Main = () => {
  ...
  const [selectedBackground, toggleSelectedBackground] = useState(1);
    ...
    <>
      <div className={app.section}>
        <div className={background.imageScroller}>
          <img
            className={[background.image, selectedBackground = 0 && background.imageFade].join(" ")}
            src={require("../assets/images/background" + (selectedBackground - 1) + ".jpg")}
            alt=""
          />
          <img
            className={[background.image, selectedBackground = 1 && background.imageFade].join(" ")}
            src={require("../assets/images/background" + selectedBackground + ".jpg")}
            alt=""
          />
          <img
            className={[background.image, selectedBackground = 2 && background.imageFade].join(" ")}
            src={require("../assets/images/background" + (selectedBackground + 1) + ".jpg")}
            alt=""
          />
          ...
          <img
            ...
            onClick={() =>
              selectedBackground < 2 ? toggleSelectedBackground((state) => state + 1) : ""
            }
          ...
          <img
            className={background.arrow}
            onClick={() =>
              selectedBackground > 0 ? toggleSelectedBackground((state) => state - 1) : ""
            }
