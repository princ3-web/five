  ...
  return (
    <>
      <div className={subpage.section}>
        <div className={newspicker.newsItem} style={{width: "100%", marginTop: "10rem"}}>
          <img
          ...
          />
          <div style={{ width: "50%" }}>
            <div className={newspicker.newsItemTitle} style={{width: "100%", marginTop: "10rem"}}>{NewsFile[data.newsID].title}</div>
