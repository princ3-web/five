    ...
    <>
      <div className={subpage.section}>
        <div
          ...
          style={{ width: "100%", paddingBlock: "15rem", paddingInline: "7rem", boxSizing:"border-box", backgroundColor:"red" }}
        >
          <img
          ...
          />
          <div style={{ width: "50%" }}>
            <div className={newspicker.newsItemTitle} style={{ fontSize: 30, marginBottom: "2rem" }}>
