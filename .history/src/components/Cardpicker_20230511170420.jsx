...
const Cardpicker = () => {
  const cards = [
    ...
    { title: "Advanced", text: "This plan is designed for users with more demanding computing requirements. It offers advanced features and customization options for optimized performance and flexibility." },
    { title: "Enterprise", text: "This plan is tailored for enterprises with complex computing needs and mission-critical applications. It provides a comprehensive suite of features and services to support large-scale operations.
