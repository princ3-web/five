...
const Newspicker = () => {
  ...
  const news = [
    ...
    { image: require("../assets/images/background2.webp"), title: "GPUs for next-generation gaming experiences", text: "" },
    {
      image: require("../assets/images/background2.webp"),
      title:
  ...
  const events = [
    ...
    { image: require("../assets/images/background2.webp"), title: "Save the date for our annual technology summit", text: "" },
    {
      image: require("../assets/images/background2.webp"),
      title:
