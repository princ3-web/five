...
const Newspicker = () => {
  ...
  const News = [
    {
      image: require("../assets/images/news/news0.webp"),
    ...
    {
      require("../assets/images/news/news0.webp"),
  ...
  return (
    <div className={newspicker.newspicker}>
      ...
      <div className={newspicker.newsContainer}>
        {(selectedButton === 0 ? News : selectedButton === 1 ? Events : selectedButton === 2 ? Community : News).map(
          (item, n) =>
            n < 5 && (
