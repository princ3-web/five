...
const Imagescroller = () => {
  ...
  const backgroundsText = [
    ...
    {
      title: "Grow with us",
      text: "Our company offers opportunities for professional growth and advancement, with chances to specialize in areas such as design, manufacturing, or research.",
    },
    {
    ...
    <div>
      <div className={imagescroller.imageScroller}>
        ...
        <img
          ...
          style={{ left: "0.25rem", rotate: "180deg", translateY: "-50%" }}
