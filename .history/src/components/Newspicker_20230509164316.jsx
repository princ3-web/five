  ...
  const news = [
    {
      ...
      title:
        "New lineup of cutting-edge technologies for advanced computing",
      text: "",
    },
    {
      image: require("../assets/images/background2.webp"),
    ...
    },
    {
      image: require("../assets/images/background2.webp"),
      title:
        "Innovative technology startup reveals new AI chip",
      text: "",
    },
    {
      image: require("../assets/images/background2.webp"),
    ...
    },
    {
      image: require("../assets/images/background2.webp"),
      title:
        "New processor technology poised to disrupt the industry",
      text: "",
    },
    {
      image: require("../assets/images/background2.webp"),
    ...
    <div className={newspicker.newspicker}>
      ...
      <div className={newspicker.newsItem}>
            <img
              ...
              src={require("../assets/images/news/news" + 0 + ".webp")}
              alt=""
            />
            <div style={{ width: "50%" }}>
              <div className={newspicker.newsItemTitle}>aaa</div>
              <div className={newspicker.newsItemText}>bbb</div>
            </div>
          </div>
