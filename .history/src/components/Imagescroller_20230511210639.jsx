...
const Imagescroller = () => {
  ...
  const backgroundsText = [
    ...
    {
      title: "Grow with us",
      text: "Our c opportunities for professional growth and advancement, with chances to specialize in areas such as architecture, design, manufacturing, or research.",
    },
    {
